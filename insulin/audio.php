    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <button onclick="window.location.href='addaudio.php'" class="btn btn-primary btn-round">Add Audio File</button></td>
                    </div>
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                ...
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td><audio controls>
                                        <source src="<?php echo $row['file_audio_file']?>" type="audio/mp3">
                                        </audio>
                                    </td>
                                    <td><button onclick="window.location.href='deleteaudio.php?id=<?php echo $row['file_id']; ?>'" class="btn btn-danger btn-round">Delete</button></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
