...
$sql = "SELECT * FROM insulin WHERE insulin_id = '$insulin_id'";
...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE insulin SET insulin_name='$insulin_name',insulin_desc='$insulin_desc', insulin_purchase_date='$insulin_purchase_date', insulin_injection_start_date='$insulin_injection_start_date', insulin_injection_end_date='$insulin_injection_end_date'";
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Insulin Name" name="insulin_name" value="<?php echo $row['insulin_name'];?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <textarea name="insulin_desc" id="description" cols="30" rows="5" class="form-control" placeholder="Insulin Description" value="<?php echo $row['insulin_desc'];?>"></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Purchase Date</label>
                                    <input type="date" class="form-control" placeholder="Purchase Date" name="insulin_purchase_date" value="<?php echo $row['insulin_purchase_date'];?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Injection Start Date</label>
                                    <input type="date" class="form-control" placeholder="Injection Start Date" name="insulin_injection_start_date" value="<?php echo $row['insulin_injection_start_date'];?>">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Injection End Date</label>
                                    <input type="date" class="form-control" placeholder="Injection End Date" name="insulin_injection_end_date" value="<?php echo $row['insulin_injection_end_date'];?>">
                                </div>
                            </div>
                            
                            <div class="col-sm-12">
                                    <button type="submit" name="submit" class="btn btn-primary btn-round">Edit Insulin</button>
                                    <a href="insulin.php" class="btn btn-warning btn-round ">Cancel</a>
                                </div>
                        </div>
                    </div>
                </div>
