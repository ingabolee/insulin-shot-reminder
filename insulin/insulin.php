    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <button onclick="window.location.href='addinsulin.php'" class="btn btn-primary btn-round">Add Insulin</button></td>
                    </div>
                    <div class="body">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tr>
                                ...
                                <?php   while($row = mysqli_fetch_assoc($rows)):?>
                                    ...
                                    <td  onclick="window.location.href='editinsulin.php?id=<?php echo $row['insulin_id']; ?>'"><?php echo $row["insulin_name"]?></td>
                                    <td  onclick="window.location.href='editinsulin.php?id=<?php echo $row['insulin_id']; ?>'"><?php echo $row["insulin_desc"]?></td>
                                    <td  onclick="window.location.href='editinsulin.php?id=<?php echo $row['insulin_id']; ?>'"><?php echo $row["insulin_purchase_date"]?></td>
                                    <td  onclick="window.location.href='editinsulin.php?id=<?php echo $row['insulin_id']; ?>'"><?php echo $row["insulin_injection_start_date"]?></td>
                                    <td  onclick="window.location.href='editinsulin.php?id=<?php echo $row['insulin_id']; ?>'"><?php echo $row["insulin_injection_end_date"]?></td>
                                    <td><button onclick="window.location.href='editinsulin.php?id=<?php echo $row['insulin_id']; ?>'" name="submit" class="btn btn-warning btn-round">Edit</button></td>
                                    <td><button onclick="window.location.href='deleteinsulin.php?id=<?php echo $row['insulin_id']; ?>'" class="btn btn-danger btn-round">Delete</button></td>
                                </tr>
                                <?php  endwhile; ?>
                            </tbody>
                        </table>
